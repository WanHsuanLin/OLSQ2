...
from pyolsq.apiPy import OLSQ
from pyolsq.device import qcdevice
from pyolsq.olsq_cirq.input import input_cirq


class OLSQ_cirq(OLSQ):
    def __init__(self, obj_is_swap: bool, mode: str):
        ...
        super().__init__(self, obj_is_swap: bool, mode: str)
