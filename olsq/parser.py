def input_qasm(circ_str: str):
    """Process an input qasm string parsing parameters
    ...
    for qasmline in circ_str.splitlines():
        ...
        # grammer > 3 -> testing parameters
        # grammer=1 incorrect, raise an error
        ...
        elif words[0] == "//" and words[1] == "moment":
            count = words[2]
    ...
    return count
        ...
        # if words[0] in ['cx', 'zz', 'u4', 'rzz(pi/4)', 'SWAP']:
        #     if grammar == 3:
        #         try:
