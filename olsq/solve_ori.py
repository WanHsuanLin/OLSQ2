...
from z3 import set_option, Int, IntVector, Bool, Optimize, Implies, And, Or, If, sat, Solver
...
class OLSQ:
    def __init__(self, objective, mode, encoding, swap_up_bound = -1):
    ...
    def solve(self, output_mode: str = None, output_file_name: str = None):
        ...
        print("Optimization time = {}, time including preprocessing = {}.".format(datetime.datetime.now() - start_time, timeit.default_timer()-self.start))
        model = lsqc.model()
